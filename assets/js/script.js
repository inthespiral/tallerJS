$(document).ready(function() {
  ...
  //   $('.publicaciones').append('<section class="container bg-light mb-2 pt-3 rounded"><div class="row"><div class="col-1"><img class="imgPerfil img-fluid" src=assets/img/pensador.jpg" alt=""></div><div class="col-10"><h4>Pensador <span>@mansocra</span></h4><p>' + $('.inputPerfil').val() + '</p><p><a class="like" href="#"><i class="far fa-heart"></i></a><span class="ml-2">0</span></p></div><div class="col-1"><a class="eliminarTwitt" href="#"><i class="fas fa-times"></i></a></div></div></section>')
  //   $('.inputPerfil').val('')
  // });
